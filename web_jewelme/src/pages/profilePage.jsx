      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 flex flex-col items-center">
              <div className="relative group">
                <div className="w-44 h-44 rounded-full overflow-hidden border-[6px] border-white shadow-xl ring-1 ring-gray-100">
                  <img
                    src={previewImage || profile.profileImage || "https://ui-avatars.com/api/?background=D4AF37&color=fff&name=" + profile.name}
                    alt="Profile"
                    className="w-full h-full object-cover transition duration-500 group-hover:scale-110"
                  />
                </div>
                <label className="absolute bottom-2 right-2 p-3 bg-[#D4AF37] rounded-2xl text-white cursor-pointer hover:bg-[#B8962E] shadow-lg shadow-yellow-100 transition-all active:scale-90 hover:-translate-y-1">
                  <FaCamera size={18} />
              ...
              {selectedFile && (
                <div className="mt-6 w-full space-y-2">
                  <button
                    ...
                    className="w-full py-3 bg-[#D4AF37] text-white font-bold rounded-2xl hover:bg-[#B8962E] shadow-lg shadow-yellow-100 transition-all"
                  >
                    Upload Image
                  </button>
                  <button
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(212,175,55,0.07)] border border-gray-50/50">
              <div className="flex justify-between items-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                  <span className="p-2 bg-yellow-50 text-[#D4AF37] rounded-xl"><FaUserEdit size={20} /></span>
                  Personal Details
                </h3>
                {!isEditMode && (
                  <button
                    onClick={() => setIsEditMode(true)}
                    className="px-4 py-2 text-sm font-bold text-[#D4AF37] bg-yellow-50 rounded-xl hover:bg-yellow-100 transition-all"
                  >
                    Edit Profile
                  </button>
                )}
              ...
              <form onSubmit={handleProfileSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-4 rounded-2xl border transition-all duration-300 outline-none ${
                        isEditMode 
                        ? "border-yellow-200 bg-white shadow-[0_4px_12px_rgba(212,175,55,0.08)] focus:border-[#D4AF37]" 
                ...
                {isEditMode && (
                  <div className="flex items-center gap-4 pt-4 animate-slide-up">
                    <button
                      type="submit"
                      className="flex-[2] py-4 bg-[#D4AF37] text-white font-bold rounded-2xl hover:bg-[#B8962E] shadow-xl shadow-yellow-100 transition-all active:scale-95"
                    >
                      Update Profile
                    </button>
                    <button
            ...
            <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(212,175,55,0.07)] border border-gray-50/50">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                <span className="p-2 bg-yellow-50 text-[#D4AF37] rounded-xl"><FaLock size={20} /></span>
                Security
              </h3>
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-6">
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full pl-6 pr-14 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-yellow-200 focus:shadow-[0_4px_12px_rgba(212,175,55,0.08)] outline-none transition-all"
                  />
                  <button
                    type="button"
                    className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300 hover:text-[#D4AF37] transition-colors"
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-[#D4AF37] text-white font-bold rounded-2xl hover:bg-[#B8962E] shadow-xl shadow-yellow-100 transition-all active:scale-95"
                >
                  Change Password
                </button>
              </form>
...
//                 <button
//                   type="submit"
//                   className="w-full py-4 bg-[#D4AF37] text-white font-bold rounded-2xl hover:[#B8962E] shadow-xl shadow-purple-200 transition-all active:scale-95"
//                 >
//                   Change Password
//                 </button>
//               </form>
